...
#define PMUT          30   //muta��o 30%
#define PREC          100  //recombina��o 100%
...
void cruzamento(ind_t ind_1, ind_t ind_2);
...
void cruzamento(ind_t ind_1, ind_t ind_2) {
	...
	//inverte os genes de ind_1 e ind_2
	...
	//Gera os filhos
	filhos.cromossomo[0] = ind_1.id;
	filhos.cromossomo[1] = ind_2.id;
...
void mutacao(ind_t *individuo) {
	int pmut = rand() % 100;
		...
		if (pmut >= PMUT) 
		{
			// Escolha o ponto de muta��o
			int ponto_de_mutacao = rand() % GENES;
