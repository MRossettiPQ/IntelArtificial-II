...
int main(int argc, char *argv[]) 
{
	...
	{
		randomico1 = rand() % 119;																											//CHAMADA E CRIAÇÃO DE VALOR RANDOMICO PARA ENTRADA DO SENSOR
		randomico2 = rand() % 119;																											//CHAMADA E CRIAÇÃO DE VALOR RANDOMICO PARA ENTRADA DO SENSOR
